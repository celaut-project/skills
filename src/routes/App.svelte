<script lang="ts">
  ...
  import SkillDetailView from "$lib/components/celaut/SkillDetailView.svelte";
...
<main class="main-content">
  ...
  {:else if selectedSkill}
      <SkillDetailView
        ...
        {siblingSkills}
        {relatedSkills}
        {selectedSkillReputation}
        {skillSources}
        bind:detailVisible
        bind:detailTab
        bind:selectedBenchmarkId
        bind:shareModalOpen
        bind:showCreateBenchmarkForm
        bind:benchmarkName
        bind:benchmarkDescription
        bind:benchmarkMetrics
        bind:benchmarkDescriptors
        bind:benchmarkSourceHash
        bind:benchmarkSubmitting
        bind:expandedAllCases
        {backToGallery}
        {selectSkill}
        {forkSkill}
        {discussRelationship}
        ...
        {addBenchmarkDescriptor}
        {removeBenchmarkDescriptor}
        {computeRecommendedService}
        {recommendedDownloadPromise}
        {collectServiceResults}
        {computeServiceCompositeScore}
        {toggleAllCases}
        {allCasesKey}
        {collectIndividualCases}
